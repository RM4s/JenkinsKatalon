...
WebUI.navigateToUrl(GlobalVariable.urlKatalonDemo)

WebUI.click(findTestObject('Object Repository/demoUATKatalon/Page_CURA Healthcare Service/a_Make Appointment'))

WebUI.setText(findTestObject('Object Repository/demoUATKatalon/Page_CURA Healthcare Service/input_Username_username'), GlobalVariable.User)
