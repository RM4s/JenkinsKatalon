...
'# Verificar si antes de pulsar el botón login el elemento es clicable'
WebUI.verifyElementClickable(findTestObject('Object Repository/demoUATKatalon/Page_CURA Healthcare Service/button_Login'))
