...
WebUI.click(findTestObject('demoUATKatalon/Page_CURA Healthcare Service/Page_CURA Healthcare Service/a_CURA Healthcare_menu-toggle'))

WebUI.click(findTestObject('demoUATKatalon/Page_CURA Healthcare Service/Page_CURA Healthcare Service/a_Logout'))
